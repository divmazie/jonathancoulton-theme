...
# this copied without modifications from from https://raw.githubusercontent.com/acabal/scripts/master/ogg-cover-art
# ok, i added some mime types
...
if [ "${oggMimeType}" != "audio/x-vorbis+ogg" -a "${oggMimeType}" != "audio/ogg"  -a "${oggMimeType}" != "application/ogg"  -a "${oggMimeType}" != "audio/opus" ]; then
